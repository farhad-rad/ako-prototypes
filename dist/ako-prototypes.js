    ...
    Object.prototype.toFormData = function () {
        ...
        var binder = function binder(data, parentKey) {
            if (data && (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && !(data instanceof Date) && !(data instanceof File) && !(data instanceof Blob) && !(typeof TimeSpan === 'function' && data instanceof TimeSpan)) {
                ...
                var value = data == null ? '' : data instanceof Date ? data.toISOString() : typeof TimeSpan === 'function' && data instanceof TimeSpan ? data.valueOf() : data;
...
module.exports = function () {
    /**
     * Escapes Special Characters By Adding \ In Base String
     * *** Note: Does Not Escape BackSlashes(\)
     * @returns {String}
     */
    String.prototype.toRegexQuote = function () {
